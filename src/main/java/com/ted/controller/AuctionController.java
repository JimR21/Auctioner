...
//	@PreAuthorize("hasRole('ROLE_BIDDER')")
	...
	public String newAuctionPost(@Valid @ModelAttribute("auction") Auction auction, BindingResult result, Model model) {
		
		System.out.println("Auction Saved! " + auction.getName());
